...
#print mydict.keys()[mydict.values().index(16)] # prior to Python 3.x -- referring dictionary keys based on the value.

#print(list(mydict.keys())[list(mydict.values()).index(16)]) # from Python 3.x
